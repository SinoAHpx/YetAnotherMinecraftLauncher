...
internal class SettingsViewModel : ViewModelBase
{
    public SettingsViewModel()
    {
        ...
        this.WhenAnyValue(v => v.ColorIndex).Subscribe(s => { theme.PrimaryColor = Colors[s].MapPrimaryColor(); });
        ...
        this.WhenAnyValue(x1 => x1.AllocatedMemorySize,
            ...
            .Subscribe(async t => { await t.WriteConfigAsync(ConfigNodes.Settings); });
        ...
        this.WhenAnyValue(x => x.CustomMinecraftDirectory,
            ...
            .Subscribe(x => { MessengerRoutes.UpdateVersions.Knock(); });
    ...
    private int _afterLaunchAction;
    ...
    public async void BrowseJava()
    {
        ...
        dialog.CancelActionCommand = ReactiveCommand.Create(() => { DialogHost.Close(null); });
